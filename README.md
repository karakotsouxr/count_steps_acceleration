...
> Άνοιγμα αυτής της σελίδας στο [https://karakotsouxr.github.io/count_steps_acceleration/](https://karakotsouxr.github.io/count_steps_acceleration/)
...
* αναζήτηση για **https://github.com/karakotsouxr/count_steps_acceleration** και εισαγωγή
...
* επικολλήστε **https://github.com/karakotsouxr/count_steps_acceleration** και κάντε κλικ στην εισαγωγή
